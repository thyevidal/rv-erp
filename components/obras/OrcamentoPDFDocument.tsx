...
const S = StyleSheet.create({
  page: { fontFamily: 'Helvetica', fontSize: 9, backgroundColor: '#ffffff', paddingBottom: 40 },
  // Header
  ...
  logoPlaceholderText: { fontFamily: 'Helvetica-Bold', fontSize: 18, color: '#ffffff' },
  companyName: { fontFamily: 'Helvetica-Bold', fontSize: 11, color: '#ffffff' },
  companyInfo: { fontSize: 8, color: '#ffffff', opacity: 0.8 },
  docTitle: { fontFamily: 'Helvetica-Bold', fontSize: 13, color: '#ffffff', textAlign: 'right', letterSpacing: 1.5 },
  ...
  obraName: { fontFamily: 'Helvetica-Bold', fontSize: 17, color: '#ffffff' },
  ...
  prazoValue: { fontFamily: 'Helvetica-Bold', fontSize: 10, color: '#ffffff', marginTop: 2 },
  accentBar: { height: 5 },
  ...
  miniHeaderName: { fontFamily: 'Helvetica-Bold', fontSize: 8, color: '#ffffff' },
  ...
  sectionTitle: { fontFamily: 'Helvetica-Bold', fontSize: 8, letterSpacing: 1.2, marginBottom: 8, marginTop: 16, paddingBottom: 4, borderBottomWidth: 1, borderBottomColor: '#e5e7eb' },
  // Serviços
  ...
  tableHeaderText: { fontFamily: 'Helvetica-Bold', fontSize: 8, color: '#ffffff', letterSpacing: 0.8 },
  ...
  itemDesc: { fontFamily: 'Helvetica-Bold', fontSize: 9, color: '#111827' },
  itemSub: { fontSize: 7.5, color: '#6b7280', marginTop: 2 },
  itemValue: { fontFamily: 'Helvetica-Bold', fontSize: 10, color: '#111827' },
  ...
  impostoLabel: { fontFamily: 'Helvetica-Bold', fontSize: 9, color: '#92400e' },
  impostoValue: { fontFamily: 'Helvetica-Bold', fontSize: 10, color: '#92400e' },
  ...
  totalLabel: { fontFamily: 'Helvetica-Bold', fontSize: 11, color: '#111827' },
  ...
  infoBoxValue: { fontFamily: 'Helvetica-Bold', fontSize: 11, color: '#111827' },
  infoBoxValueAccent: { fontFamily: 'Helvetica-Bold', fontSize: 14 },
