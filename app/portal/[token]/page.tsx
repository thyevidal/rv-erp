                ...
                <div className="body">
                    ...
                    {isCorrespond && (
                        <div className="card">
                            ...
                            <p style={{ fontSize: '13px', color: '#6B6860', marginBottom: '12px' }}>
                                Para enviar documentos, entre em contato diretamente com o construtor pelo e-mail ou WhatsApp cadastrado.
                            </p>
                        </div>
                    )}
